...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" style="height: 254px; ">
  ...
  <body>
		...
		<div class="titulo"><img src=".\imagenes\LogoBBVA.png" class="LogoPeq"><h3>Creación Usuario Hijo</h3></div>

		<form id="back" name="back" method="post" action="RegistroP.php">
			<input id="imgEdit" type="image" src=".\imagenes\Back01.png" alt="Smiley face">Atras
				...
				<form action="" method="POST"> 
					...
					<input type="submit" id="Crear" name="Crear" value="Crear" style="width: 100%;" onclick="location.href='./Index1.php';">
				</form>
			</div>
		</div>	
</body>
